...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-muted/30 mt-20" role="contentinfo">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2" aria-label="AnimeVerse Home">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Anime streaming focused on dependable playback, discovery, and personal tracking.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            Copyright {new Date().getFullYear()} AnimeVerse. All rights reserved.
          </p>
